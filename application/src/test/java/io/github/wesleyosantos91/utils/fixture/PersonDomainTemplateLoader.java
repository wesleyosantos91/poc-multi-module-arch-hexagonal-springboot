...
public class PersonDomainTemplateLoader implements TemplateLoader {
    ...
    public void load() {
        ...
        Fixture.of(PersonDomain.class).addTemplate("create", new Rule(){{
            add("name", "wesley");
        ...
        Fixture.of(PersonDomain.class).addTemplate("created", new Rule(){{
            add("id", 1L);
            add("name", "wesley");
            add("dateOfBirth", LocalDate.of(1991, 6, 12));
            add("cpf", "03669252100");
        ...
        Fixture.of(PersonDomain.class).addTemplate("update", new Rule(){{
            add("name", "wesley");
            add("dateOfBirth", LocalDate.of(1991, 6, 12));
            add("cpf", "03669252100");
